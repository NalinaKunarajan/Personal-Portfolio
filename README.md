...
2. Rename it exactly to `profile.png` (PNG also works if you change the HTML path).
...
The website uses the relative path `assets/profile.png`, so GitHub Pages can load the image correctly.
